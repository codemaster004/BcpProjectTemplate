...
int main() {
	/*
	 * HEADS UP.
	 * Reading parts in those weird long *starry* explanations is definitely not required.
	 * Better keep your sanity and skip them, however if you feel brave enough feel free to read them.
	 * They contain some additional explanation that you should be able to live without.
	 * HAVE FUN!
	 */
